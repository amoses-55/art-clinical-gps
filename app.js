...
const sessionSteps = [
    {
        ...
        prompt: `
            <div style="text-align:left; max-width:650px; margin:0 auto;">
                ...
                <p>
                    Explain the ART process, establish safety, and confirm the client is ready to begin.
                </p>
                ...
                ">
                    <p>
                        “Today we will work with a memory, image, situation, or body sensation
                        that is causing distress. You do not have to tell me every detail.
                        I will guide you through the process while you remain in control.”
                    </p>

                    <p>
                        “I will ask you to follow my hand with your eyes.
                ...
                <textarea
                    id="openingNotes"
                    rows="4"
                    placeholder="Optional non-identifying session notes..."
                    oninput="saveOpeningNotes(this.value)"
                    style="
                        width:100%;
                        padding:12px;
                        border-radius:8px;
...

    {
        ...
        prompt: `
            <div style="text-align:left; max-width:650px; margin:0 auto;">
                ...
                <p>
                    Identify the memory, image, trigger, future fear,
                    or body sensation to address.
                </p>
                ...
                <textarea
                    ...
                    style="
                        ...
                        box-sizing:border-box;
                    "
                >${escapeHtml(sessionData.targetDescription)}</textarea>
...

    {
        ...
        prompt: `
            <div style="text-align:left; max-width:650px; margin:0 auto;">
                ...
                <p>
                    Clarify which scene, image, or moment is connected
                    to the strongest distress.
                </p>
                ...
                ">
                    <p>
                        ...
                        what scene or image stands out most?”
                    </p>

                    <p>
                        “Does this feel like the original event,
                        or does another memory come up?”
                    </p>

                    <p>
                        “Which moment carries the strongest emotional
